...
def main() -> None:
    ...
    if state["method"] != "convex_quad_free" or state["side"] != 257:
        raise ValueError("requires a 257-square free-center direct-map checkpoint")
